"""
Backend-local copy of the shared CRUD helper layer originally defined in etl/.

Keeping a copy in the backend container avoids changing the ETL module while
still letting backend imports resolve cleanly from its own build context.
"""
